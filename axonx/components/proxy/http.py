...
# Starlette. ``host`` is owned by the selected upstream, while content length is
# derived from the unchanged body.
...
def _response_headers(response: httpx.Response) -> list[tuple[str, str]]:
    ...
    excluded = _HOP_BY_HOP_HEADERS | {"content-encoding"} | _connection_headers(pairs)
