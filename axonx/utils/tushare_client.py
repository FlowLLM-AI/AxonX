"""Minimal Tushare Pro HTTP client with retry and pagination support."""
...
class TushareClient:
    ...
    def _wait(self, api_name: str, attempt: int, delay: float, error: object, limit: int | None = None) -> float:
